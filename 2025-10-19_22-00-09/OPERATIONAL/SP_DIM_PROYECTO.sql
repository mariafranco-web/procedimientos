CREATE PROCEDURE `amrl-data-prd`.OPERATIONAL.SP_DIM_PROYECTO()
OPTIONS(
  description="Propósito: Crear y actualizar la tabla DIM_PROYECTO en el DataSet de PRESENTATION, La tabla consolida los atributos revelantes de cada subetapa. Contiene datos como el codigo macroconsolidador y codigo macroproyecto.\nAutor: Anderson Murte\nUsos: Tablero de Indicadores x Inteligencia de Negocios, Escrituracion\nModificaciones:\n2025-07-17: Se incluye la columna ESTADO_PROYECTO\n2025-08-28 (MF): Se incluye VALOR_CONFIRMACION y VALOR_SEPARACION de la hoja de vida del proyecto")
BEGIN
    CREATE OR REPLACE TABLE `amrl-data-prd.PRESENTATION.DIM_PROYECTO` 
    --PARTITION BY DATE(FECHA_ULTIMA_ACTUALIZACION_ORC) 
