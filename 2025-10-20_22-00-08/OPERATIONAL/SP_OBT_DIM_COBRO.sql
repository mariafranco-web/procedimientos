CREATE PROCEDURE `amrl-data-prd`.OPERATIONAL.SP_OBT_DIM_COBRO()
OPTIONS(
...
BEGIN
    CREATE OR REPLACE TABLE `amrl-data-prd.CONSUMPTION.OBT_DIM_COBRO`  PARTITION BY FECHA CLUSTER BY NUMERO_DE_COBRO AS
      SELECT  
            dc.SK_COBRO
            ,dc.NUMERO_DE_COBRO
            ,dc.RECIBO
