...
(
  SELECT  SHA256(CAST(HZP.PARTYID AS STRING))     AS SK_PERSONA,
          ...
          HZPP.ATTRIBUTE3                         AS TIPO_IDENTIFICACION,
          CASE
