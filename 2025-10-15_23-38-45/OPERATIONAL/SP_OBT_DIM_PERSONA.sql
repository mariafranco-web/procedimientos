CREATE PROCEDURE `amrl-data-prd`.OPERATIONAL.SP_OBT_DIM_PERSONA()
OPTIONS(
...
BEGIN
    CREATE OR REPLACE TABLE `amrl-data-prd.CONSUMPTION.OBT_DIM_PERSONA`  PARTITION BY DATE(FECHA_VINCULACION) CLUSTER BY BK_PERSONA AS
